...
/* __string_template__7e4757925dff3ffda055ab386511256fdfe2d9e7033b480041373ff14723e923 */
class __TwigTemplate_b1db95f831ef5c36c62025a8b9775e25d339e9e26cc1ed01bcb158aa8c2b05e5 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"tagdate\">
      <div class=\"tag\">";
        // line 4
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["field_tag"] ?? null), 4, $this->source), "html", null, true);
        echo "</div>
      <div class=\"date\">";
        // line 5
    ...
    {
        return "__string_template__7e4757925dff3ffda055ab386511256fdfe2d9e7033b480041373ff14723e923";
    }
...
</div>", "__string_template__7e4757925dff3ffda055ab386511256fdfe2d9e7033b480041373ff14723e923", "");
    }
